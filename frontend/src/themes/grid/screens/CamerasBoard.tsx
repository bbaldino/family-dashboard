...
export function CamerasBoard() {
  ...
  // returns null for the *whole* integration if any single `cameras.*` value
  ...
  const cameraUrl = isPending
    ? null
    : data?.['cameras.doorbell_live_url'] || defaults.doorbell_live_url || null
